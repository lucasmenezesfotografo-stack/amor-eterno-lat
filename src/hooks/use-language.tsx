...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'register.title': 'Crear tu página de amor ❤️',
    'register.desc': 'Crea una cuenta rápida para guardar y acceder a tu página cuando quieras.',
    'register.name.label': 'Tu nombre',
    'register.name.placeholder': 'Ej: María',
    'register.password.label': 'Contraseña',
    'register.password.placeholder': 'Mínimo 6 caracteres',
    'register.password.hint': 'Usa esta contraseña para acceder a tu página después.',
    'register.submit': 'Continuar',
    'register.loading': 'Creando cuenta...',
    'register.footer': 'Solo necesitas esto una vez. Proceso rápido y seguro.',
    'register.toast.name.title': 'Nombre requerido',
    'register.toast.name.desc': 'Por favor ingresa tu nombre.',
    'register.toast.password.title': 'Contraseña muy corta',
    'register.toast.password.desc': 'La contraseña debe tener al menos 6 caracteres.',
    'register.toast.success.title': '¡Cuenta creada!',
    'register.toast.success.desc': 'Ahora puedes crear tu página de amor.',
    'register.toast.error.title': 'Error',
    'register.toast.unexpected.title': 'Error inesperado',
    'register.toast.unexpected.desc': 'Por favor, intenta de nuevo.',
    'register.error.taken': 'Este nombre ya está en uso. Prueba con otro nombre.',
    'register.error.password': 'La contraseña debe tener al menos 6 caracteres.',
    'register.error.generic': 'No se pudo crear la cuenta. Intenta de nuevo.',
    ...
    'crear.photo.framing': 'Ajustar encuadre de la foto',
    'crear.photo.framing.desc': 'Desliza para elegir qué parte de la foto aparece',
    'crear.photo.framing.top': 'Arriba',
    'crear.photo.framing.center': 'Centro',
    'crear.photo.framing.bottom': 'Abajo',
    'crear.photo.preview': 'Así se verá en el celular',
  ...
  en: {
    ...
    'register.title': 'Create your love page ❤️',
    'register.desc': 'Create a quick account to save and access your page whenever you want.',
    'register.name.label': 'Your name',
    'register.name.placeholder': 'Ex: Maria',
    'register.password.label': 'Password',
    'register.password.placeholder': 'Minimum 6 characters',
    'register.password.hint': 'Use this password to access your page later.',
    'register.submit': 'Continue',
    'register.loading': 'Creating account...',
    'register.footer': 'You only need this once. Quick and secure process.',
    'register.toast.name.title': 'Name required',
    'register.toast.name.desc': 'Please enter your name.',
    'register.toast.password.title': 'Password too short',
    'register.toast.password.desc': 'Password must be at least 6 characters.',
    'register.toast.success.title': 'Account created!',
    'register.toast.success.desc': 'Now you can create your love page.',
    'register.toast.error.title': 'Error',
    'register.toast.unexpected.title': 'Unexpected error',
    'register.toast.unexpected.desc': 'Please try again.',
    'register.error.taken': 'This name is already in use. Try another name.',
    'register.error.password': 'Password must be at least 6 characters.',
    'register.error.generic': 'Could not create account. Try again.',
    ...
    'crear.photo.framing': 'Adjust photo framing',
    'crear.photo.framing.desc': 'Slide to choose which part of the photo appears',
    'crear.photo.framing.top': 'Top',
    'crear.photo.framing.center': 'Center',
    'crear.photo.framing.bottom': 'Bottom',
    'crear.photo.preview': 'How it appears on mobile',
  ...
  pt: {
    ...
    'register.title': 'Crie sua página de amor ❤️',
    'register.desc': 'Crie uma conta rápida para salvar e acessar sua página quando quiser.',
    'register.name.label': 'Seu nome',
    'register.name.placeholder': 'Ex: Maria',
    'register.password.label': 'Senha',
    'register.password.placeholder': 'Mínimo 6 caracteres',
    'register.password.hint': 'Use esta senha para acessar sua página depois.',
    'register.submit': 'Continuar',
    'register.loading': 'Criando conta...',
    'register.footer': 'Você só precisa disso uma vez. Processo rápido e seguro.',
    'register.toast.name.title': 'Nome obrigatório',
    'register.toast.name.desc': 'Por favor, insira seu nome.',
    'register.toast.password.title': 'Senha muito curta',
    'register.toast.password.desc': 'A senha deve ter no mínimo 6 caracteres.',
    'register.toast.success.title': 'Conta criada!',
    'register.toast.success.desc': 'Agora você pode criar sua página de amor.',
    'register.toast.error.title': 'Erro',
    'register.toast.unexpected.title': 'Erro inesperado',
    'register.toast.unexpected.desc': 'Por favor, tente novamente.',
    'register.error.taken': 'Este nome já está em uso. Tente outro nome.',
    'register.error.password': 'A senha deve ter no mínimo 6 caracteres.',
    'register.error.generic': 'Não foi possível criar a conta. Tente novamente.',
    ...
    'crear.photo.framing': 'Ajustar enquadramento da foto',
    'crear.photo.framing.desc': 'Deslize para escolher qual parte da foto aparece',
    'crear.photo.framing.top': 'Topo',
    'crear.photo.framing.center': 'Centro',
    'crear.photo.framing.bottom': 'Embaixo',
    'crear.photo.preview': 'Como aparece no celular',
  ...
  it: {
    ...
    'register.title': 'Crea la tua pagina d\'amore ❤️',
    'register.desc': 'Crea un account rapido per salvare e accedere alla tua pagina quando vuoi.',
    'register.name.label': 'Il tuo nome',
    'register.name.placeholder': 'Es: Maria',
    'register.password.label': 'Password',
    'register.password.placeholder': 'Minimo 6 caratteri',
    'register.password.hint': 'Usa questa password per accedere alla tua pagina in seguito.',
    'register.submit': 'Continua',
    'register.loading': 'Creazione account...',
    'register.footer': 'Serve solo una volta. Processo rapido e sicuro.',
    'register.toast.name.title': 'Nome richiesto',
    'register.toast.name.desc': 'Per favore inserisci il tuo nome.',
    'register.toast.password.title': 'Password troppo corta',
    'register.toast.password.desc': 'La password deve avere almeno 6 caratteri.',
    'register.toast.success.title': 'Account creato!',
    'register.toast.success.desc': 'Ora puoi creare la tua pagina d\'amore.',
    'register.toast.error.title': 'Errore',
    'register.toast.unexpected.title': 'Errore imprevisto',
    'register.toast.unexpected.desc': 'Per favore riprova.',
    'register.error.taken': 'Questo nome è già in uso. Prova un altro nome.',
    'register.error.password': 'La password deve avere almeno 6 caratteri.',
    'register.error.generic': 'Impossibile creare l\'account. Riprova.',
    ...
    'crear.photo.framing': 'Regola l’inquadratura della foto',
    'crear.photo.framing.desc': 'Scorri per scegliere quale parte della foto mostrare',
    'crear.photo.framing.top': 'Alto',
    'crear.photo.framing.center': 'Centro',
    'crear.photo.framing.bottom': 'Basso',
    'crear.photo.preview': 'Come appare sul cellulare',
