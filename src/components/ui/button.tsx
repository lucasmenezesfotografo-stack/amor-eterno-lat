  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        romantic: "bg-gradient-to-r from-primary to-accent text-primary-foreground font-medium hover:scale-105 shadow-romantic hover:shadow-[0_12px_50px_hsl(var(--accent)/0.25)]",
        gold: "bg-gradient-to-r from-gold to-gold-light text-foreground font-medium hover:scale-105 shadow-[0_4px_20px_hsl(var(--gold)/0.3)]",
        glass: "bg-card/70 backdrop-blur-xl border border-border/30 text-foreground hover:bg-card/90 shadow-glass",
      },
      size: {
