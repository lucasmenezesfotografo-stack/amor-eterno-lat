...
Sofía ❤️`
  ...
  return <main className="min-h-screen bg-background">
      ...
      {showMusicOverlay && <MusicActivationOverlay trackName={demoTrack.name} artistName={demoTrack.artist} albumCover={demoTrack.albumCover} onActivate={handleMusicActivate} />}

      {/* Demo Banner */}
      <motion.div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-primary to-rose-500 text-white py-2 sm:py-2.5 px-3 sm:px-4" initial={{
      y: -50
    }} animate={{
      y: 0
    }} transition={{
      ...
      {musicActivated && <YouTubeMusicPlayer videoId={demoTrack.youtubeVideoId} trackName={demoTrack.name} artistName={demoTrack.artist} albumCover={demoTrack.albumCover} autoPlay={true} />}
        ...
        <div className="relative z-10 text-center px-4 py-16 sm:py-20 w-full">
          ...
          duration: 0.8
            ...
            <div className="flex flex-col items-center justify-center gap-2 sm:gap-4 md:flex-row md:gap-8 mb-4 sm:mb-6">
              <motion.h1 className="text-4xl sm:text-5xl md:text-7xl font-bold" initial={{
              opacity: 0,
              x: -50
            }} animate={{
              opacity: 1,
              ...
              <motion.span className="text-3xl sm:text-4xl md:text-6xl text-primary" initial={{
              scale: 0
            }} animate={{
              scale: 1
            }} transition={{
            ...
            {/* Date Badge */}
            <motion.div className="inline-flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-card/80 backdrop-blur-xl border border-border" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            {/* Music indicator */}
            <motion.div className="mt-4 inline-flex items-center gap-2 text-sm text-muted-foreground" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
        ...
        <div className="container mx-auto max-w-md text-center">
          ...
          once: true
            ...
            <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-2xl overflow-hidden mb-4 sm:mb-6 shadow-xl shadow-primary/20">
              <img src={demoTrack.albumCover} alt={demoTrack.name} className="w-full h-full object-cover" />
            </div>
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="container mx-auto max-w-lg">
          ...
          once: true
            ...
            {/* QR Code */}
            <div ref={qrRef} className="w-40 h-40 sm:w-52 sm:h-52 mx-auto bg-card border border-border rounded-2xl sm:rounded-3xl flex items-center justify-center mb-4 sm:mb-6 p-4 sm:p-5 shadow-xl">
              <QRCodeSVG value={currentUrl} size={140} level="H" fgColor="#e11d48" bgColor="transparent" />
            </div>
